...
if lado1 + lado2 > lado3 and lado1 + lado3 > lado2 and lado2 + lado3 > lado1:
    if lado1 == lado2 == lado3:
        print("UAUU, você inseriu um triângulo Equilátero!!!")
    elif lado1 == lado2 or lado1 == lado3 or lado2 == lado3:
        print("UAUU, você inseriu um triângulo  Isósceles!!!")
    else:
        print("UAUU, você inseriu um triângulo Escaleno!!!")
else:
        print("Isso não é um triângulo, melhore!!!")
